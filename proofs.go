...
func VerifySeal(info miner.SealVerifyInfo) (bool, error) {
...
func VerifyAggregateSeals(aggregate miner.AggregateSealVerifyProofAndInfos) (bool, error) {
...
func VerifyWinningPoSt(info miner.WinningPoStVerifyInfo) (bool, error) {
...
// inputs were derived was valid, and false if not.
func VerifyWindowPoSt(info miner.WindowPoStVerifyInfo) (bool, error) {
...
func AggregateSealProofs(aggregateInfo miner.AggregateSealVerifyProofAndInfos, proofs [][]byte) (out []byte, err error) {
...
func GenerateWindowPoSt(
	...
	privateSectorInfo SortedPrivateSectorInfo,
	randomness abi.PoStRandomness,
) ([]miner.PoStProof, []abi.SectorNumber, error) {
...
func toFilPublicReplicaInfos(src []miner.SectorInfo, typ string) ([]generated.FilPublicReplicaInfo, uint, error) {
...
func fromFilPoStProofs(src []generated.FilPoStProof) ([]miner.PoStProof, error) {
	out := make([]miner.PoStProof, len(src))
...
func toFilPoStProofs(src []miner.PoStProof) ([]generated.FilPoStProof, uint, func(), error) {
	allocs := make([]AllocationManager, len(src))
