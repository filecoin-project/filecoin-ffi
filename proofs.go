...
func GetSealParamsCid(
	...
	resPtr := C.get_seal_params_cid(cProofType)
...
func GetSealVerifyingKeyCid(
	...
	resPtr := C.get_seal_verifying_key_cid(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetSealParamsPath(
	...
	resPtr := C.get_seal_params_path(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetSealVerifyingKeyPath(
	...
	resPtr := C.get_seal_verifying_key_path(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetSealCircuitIdentifier(
	...
	resPtr := C.get_seal_circuit_identifier(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetPoStParamsCid(
	...
	resPtr := C.get_post_params_cid(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetPoStVerifyingKeyCid(
	...
	resPtr := C.get_post_verifying_key_cid(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetPoStParamsPath(
	...
	resPtr := C.get_post_params_path(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetPoStVerifyingKeyPath(
	...
	resPtr := C.get_post_verifying_key_path(cProofType)
	defer C.destroy_string_response(resPtr)
...
func GetPoStCircuitIdentifier(
	...
	resPtr := C.get_post_circuit_identifier(cProofType)
	defer C.destroy_string_response(resPtr)
